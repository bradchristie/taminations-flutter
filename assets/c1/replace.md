...
its part number (for example, "the third part") or by its dance action 
(for example, "the Stars", "the Centers Trade"). Examples: "Scoot and
...
- Another shorthand for "Replace With Nothing". 
Example: "Delete all Arm Turn 1/2's and Spin Chain the Gears".
