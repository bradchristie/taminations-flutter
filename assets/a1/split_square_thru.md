...
Split Square Thru an also be done fractionally, or for a given number of hands. In these cases, the
fraction applies to those who start the call, for example, for a Split Square Thru 3/4, the
