...
Facing dancers join both hands with each other and [ Circle Left](../ms/circle.md) halfway. Without
stopping, they drop hands with each other and individually [ Veer
Left](../ms/veer.md), blending into a
...
Left](../ms/circle.md) 3/4, then continue to
