...
final List<AnimatedCall> Coordinate = [
  ...
  AnimatedCall('Coordinate',
      ...
      from:'3 and 1 Lines, Right-Hand Centers',parts:'4;2;3',
      paths:[
  ...
  AnimatedCall('Coordinate',
      ...
      from:'3 and 1 Lines, Left-Hand Centers',parts:'4;2;3',
      paths:[
        ExtendLeft.changeBeats(2).scale(2.0,0.5) +
            ExtendRight.changeBeats(2).scale(2.0,0.5) +
            LeadRight.changeBeats(2).scale(3.0,3.0) +
  ...
  AnimatedCall('Coordinate',
      ...
      from:'Lines Facing Out',parts:'4;1;3',
      paths:[
        LeadLeft.changeBeats(2).scale(1.5,3.0) +
