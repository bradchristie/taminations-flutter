...
final List<AnimatedCallItem> ChaseRight = [
  AnimatedCallHeader(
    'Chase Right',
    calls: [
      AnimatedCall(
      ...
      AnimatedCall(
        ...
        paths: [
          ...
          RunRight.scale(0.5, 1.0) + Forward_2,
        ],
      ),
  ...
  AnimatedCallHeader(
    ...
    calls: [
      AnimatedCall(
        ...
        difficulty: 2,
        paths: [
          RunLeft.changeBeats(2.5) + Forward_3.changeBeats(3.5),
      ...
      AnimatedCall(
        ...
        paths: [
          ...
          UmTurnLeft.changeBeats(1.5) + Forward_2 + FlipLeft.changeBeats(1.5),
      ...
      AnimatedCall(
        ...
        paths: [
          ...
          RunLeft.scale(0.5, 1.0) + Forward_2,
