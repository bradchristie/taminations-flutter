  ...
  final List<AnimatedCall> SplitPhantomBoxes = [
    ...
    AnimatedCall('Split Phantom Boxes Acey Deucey',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:-.75,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:.75,angle:180),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:2.25,angle:0),
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:3.75,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-2.25,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-3.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-5.25,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:1.5,y:-5.25,angle:180),
  ]),
    ...
    AnimatedCall('Split Phantom Boxes Link Up',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:5.25,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:3.75,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:2.25,angle:180),
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:.75,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-2.25,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-3.75,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-5.25,angle:180),
  ]),
      group:'Split Phantom Boxes',
      paths:[
    ...
    AnimatedCall('Split Phantom Boxes Plan Ahead',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:2.25,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:.75,angle:0),
        Dancer.fromData(gender:Gender.BOY,x:-1.5,y:-.75,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1.5,y:-2.25,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:3.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:5.25,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-3.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1.5,y:-5.25,angle:0),
  ]),
      group:'Split Phantom Boxes',
    ...
    AnimatedCall('Split Phantom Boxes Walk Out to a Wave',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:1,y:.75,angle:270),
        Dancer.fromData(gender:Gender.GIRL,x:1,y:2.25,angle:270),
        Dancer.fromData(gender:Gender.GIRL,x:1,y:3.75,angle:270),
        Dancer.fromData(gender:Gender.BOY,x:1,y:5.25,angle:270),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-.75,angle:270),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-2.25,angle:270),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-3.75,angle:270),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-5.25,angle:270),
  ]),
      group:'Split Phantom Boxes',
      paths:[
