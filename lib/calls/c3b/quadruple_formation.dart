  ...
  final List<AnimatedCall> QuadrupleFormation = [
    ...
    AnimatedCall('Quadruple Box Split Swap',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:1,y:5.25,angle:180),
        Dancer.fromData(gender:Gender.GIRL,x:1,y:3.75,angle:180),
        Dancer.fromData(gender:Gender.BOY,x:-1,y:2.25,angle:0),
        Dancer.fromData(gender:Gender.GIRL,x:-1,y:.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:.75,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:2.25,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1,y:3.75,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:-1,y:5.25,angle:0),
  ]),
      group:' ',
      paths:[
    ...
    AnimatedCall('Quadruple Column Pass and Roll',
      formation:Formation('', dancers:[
        ...
        Dancer.fromData(gender:Gender.PHANTOM,x:3,y:-1,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:3,y:-3,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-1,angle:0),
    ...
    AnimatedCall('Quadruple Wave Swing Thru',
      formation:Formation('', dancers:[
        ...
        Dancer.fromData(gender:Gender.GIRL,x:3,y:1,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-1,angle:180),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-3,angle:0),
    ...
    AnimatedCall('Quadruple Waves of 3 Swing Thru',
      formation:Formation('', dancers:[
        Dancer.fromData(gender:Gender.BOY,x:1,y:2,angle:180),
        ...
        Dancer.fromData(gender:Gender.PHANTOM,x:3,y:-2,angle:0),
        Dancer.fromData(gender:Gender.PHANTOM,x:1,y:-2,angle:180),
  ]),
      group:' ',fractions:'3',
      paths:[
          Stand.changeBeats(3) +
