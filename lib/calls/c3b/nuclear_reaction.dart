  ...
  final List<AnimatedCall> NuclearReaction = [
    ...
    AnimatedCall('Nuclear Reaction',
      ...
      paths:[
          Stand.changeBeats(3) +
          Forward_5 +
          CounterRotateRight(-1,-3).changehands(Hands.BOTH),

          ExtendLeft.changeBeats(1.5).scale(1.5,0.5) +
          ExtendRight.changeBeats(1.5).scale(1.5,0.5) +
          HingeRight.changeBeats(2.5) +
          QuarterRight.changeBeats(2.5).skew(1.0,1.0) +
          CounterRotateRight(5,-1).changehands(Hands.RIGHT),

          Stand.changeBeats(3) +
          BackHingeLeft.changeBeats(2.5) +
          LeadRight.changeBeats(2.5) +
          CounterRotateRight(1,-5).changehands(Hands.RIGHT),

          ExtendLeft.changeBeats(1.5).scale(1.5,0.5) +
          ExtendRight.changeBeats(1.5).scale(1.5,0.5) +
          RunRight.changeBeats(3.7) +
          Forward.changeBeats(1.3) +
          CounterRotateRight(3,1).changehands(Hands.BOTH)
      ]),
    ...
    AnimatedCall('Nuclear Reaction',
      ...
      paths:[
          Stand.changeBeats(3) +
          Forward_5 +
          CounterRotateRight(-1,-3).changeBeats(5).changehands(Hands.RIGHT),
          ...
          RunRight.changeBeats(3.7) +
          Forward.changeBeats(1.3) +
          CounterRotateRight(3,1).changeBeats(5).changehands(Hands.RIGHT),
