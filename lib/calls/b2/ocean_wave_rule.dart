...
import '../b1/right_and_left_thru.dart' as b1;
  ...
  final List<AnimatedCall> OceanWaveRule = [
    ...
    b1.RightAndLeftThru.where((tam) =>
      tam.title == 'Right and Left Thru' && tam.from == 'Right-Hand Waves').first.xref(title: 'Right and Left Thru'),
    b1.RightAndLeftThru.where((tam) =>
      tam.title == 'Right and Left Thru' && tam.from == 'Tidal Wave').first.xref(title: 'Right and Left Thru'),
  ];
